...
import { Sparkles, Smartphone, Gamepad2, ArrowRight } from "lucide-react";
      ...
      <div className="relative mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
        <div className="flex flex-col items-center text-center">
          ...
          <div className="inline-flex items-center gap-2 rounded-full border border-indigo-500/30 bg-indigo-950/40 px-4 py-1.5 text-xs font-semibold text-indigo-300 backdrop-blur-md mb-6 shadow-inner">
            ...
            <span>Krayirhan Studio · Mobil Oyun & Uygulama Geliştirme</span>
          </div>
          ...
          <p className="mt-6 max-w-2xl text-base sm:text-lg text-slate-300 leading-relaxed">
            {STUDIO_INFO.tagline} Bağımlılık yaratan mekaniklere sahip mobil oyunlarımız ve bilişsel bilim temelli yenilikçi uygulamalarımızla tanışın.
          </p>
          ...
          <div className="mt-8 flex flex-wrap items-center justify-center gap-4">
            <Link
              ...
              className="flex items-center gap-2 rounded-xl bg-amber-600 px-6 py-3.5 text-sm font-bold text-white shadow-xl shadow-amber-600/30 hover:bg-amber-500 hover:scale-105 transition-all"
            >
              <Gamepad2 className="h-4 w-4" />
              <span>Blok Dünyası (Oyna)</span>
            </Link>
        ...
        {/* Dual Spotlight Cards (Blok Dünyası & LingoRise) */}
        <div className="mt-16 grid grid-cols-1 lg:grid-cols-2 gap-8">
          {/* Featured Game: Blok Dünyası */}
          {featuredGame && (
            <div className="relative overflow-hidden rounded-3xl border border-amber-500/30 bg-gradient-to-br from-[#1a140d] via-[#100e0b] to-[#07090e] shadow-2xl flex flex-col justify-between">
              <div className="p-8 space-y-4">
                <div className="inline-flex items-center gap-1.5 text-xs font-bold uppercase tracking-wider text-amber-400">
                  <Gamepad2 className="h-4 w-4" />
                  <span>Mobil Oyunumuz</span>
                </div>
              ...
              <div className="relative aspect-video w-full overflow-hidden border-t border-slate-800/80 bg-slate-950/40 p-4 flex items-center justify-center">
                <img
                  src={featuredGame.coverImage}
                  alt={featuredGame.title}
                  className="max-h-[220px] w-auto object-contain rounded-xl shadow-lg border border-slate-800"
                />
              </div>
            </div>
          )}

          {/* Featured App: LingoRise */}
          {featuredApp && (
            <div className="relative overflow-hidden rounded-3xl border border-cyan-500/30 bg-gradient-to-br from-[#0c1420] via-[#091018] to-[#07090e] shadow-2xl flex flex-col justify-between">
              <div className="p-8 space-y-4">
                <div className="inline-flex items-center gap-1.5 text-xs font-bold uppercase tracking-wider text-cyan-400">
                  <Smartphone className="h-4 w-4" />
                  <span>Öne Çıkan Uygulamamız</span>
                </div>
                <h2 className="text-2xl sm:text-3xl font-extrabold text-white">
                  {featuredApp.title}
                </h2>
                ...
                <div className="pt-2 flex flex-wrap gap-2">
                  <Link
                    ...
                    className="rounded-lg bg-cyan-600 px-4 py-2 text-xs font-bold text-white hover:bg-cyan-500 transition-colors shadow-md shadow-cyan-600/30"
                  >
                    Uygulamayı İncele
                  </Link>
                  <Link
