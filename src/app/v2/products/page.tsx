...
import { ArrowRight, Download, Gamepad2, Play, Smartphone, WifiOff } from "lucide-react";
      ...
      <main className="v2-content mx-auto w-full max-w-[1380px] px-5 py-12 sm:px-8 lg:px-12 lg:py-16">
        ...
        <div className="text-center max-w-3xl mx-auto space-y-4">
          ...
          <p className="text-sm sm:text-base leading-relaxed text-[#b5b0a4]">
            Krayirhan Studio bünyesinde geliştirilen tüm bağımsız mobil oyunlar, günlük pratik uygulamalar ve dijital deneyimler.
          </p>
        ...
        <div className="mt-16 space-y-12">
          {filteredProducts.map((product, index) => {
            ...
            return (
              <div
                key={product.id}
                className="group relative overflow-hidden rounded-3xl border border-white/10 bg-[#0d1015]/80 p-7 sm:p-10 lg:p-12 transition-all duration-300 hover:border-white/20 hover:bg-[#0d1015]"
              >
                <div
                ...
                >
                  ...
                  <div className={`space-y-6 lg:col-span-6 ${isReversed ? "lg:order-2" : "lg:order-1"}`}>
                    ...
                    <div>
                      ...
                      <p className="mt-3 text-base leading-relaxed text-[#b5b0a4]">
                    ...
                    <div className="flex flex-wrap items-center gap-4 pt-4">
                      <Link
                        ...
                        className="inline-flex items-center gap-2 rounded-lg bg-white px-6 py-3 text-xs font-bold text-black shadow-lg hover:bg-neutral-200 transition"
                      >
                      ...
                      {product.links.playStore && (
                        <a
                          ...
                          target="_blank"
                          rel="noreferrer"
                          className="inline-flex items-center gap-2 rounded-lg border border-white/20 bg-white/5 px-5 py-3 text-xs font-semibold text-white hover:bg-white/10 hover:border-white/40 transition"
                        >
                  ...
                  {/* Visuals Column (2 Phone Mockups) */}
                  <div
                    className={`lg:col-span-6 flex items-center justify-center gap-4 sm:gap-6 py-4 select-none ${
                      isReversed ? "lg:order-1" : "lg:order-2"
                    }`}
                  >
                    {/* Phone 1: Cover / Primary */}
                    <div className="w-1/2 max-w-[210px] sm:max-w-[240px] -rotate-2 transform transition-all duration-500 group-hover:-rotate-1 group-hover:scale-105">
                    ...
                    {/* Phone 2: Screenshot 2 */}
                    <div className="w-1/2 max-w-[210px] sm:max-w-[240px] rotate-2 mt-6 sm:mt-10 transform transition-all duration-500 group-hover:rotate-1 group-hover:scale-105">
                      <div className="relative aspect-[9/19.5] overflow-hidden rounded-[2rem] sm:rounded-[2.4rem] border-2 border-[#2b313d] bg-[#0c0e12] p-1.5 shadow-2xl">
                        <div className="relative h-full w-full overflow-hidden rounded-[1.6rem] sm:rounded-[2rem] bg-black">
                          <Image
